...
//$root_base	  = '/offistarindo';
/*** additional for framework  ***/

//$base_url ="http://".$_SERVER['HTTP_HOST'].$root_base;  // DON'T TOUCH (base url (only domain) of site (without final /)).
$base_url ='';
$upload_dir = ''; // path from base_url to base of upload folder (with start and final /)
$current_path = '../uploads/download_files/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../uploads/download_files/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$access_keys = array($_REQUEST['akey'],'someoneElseKey');
...
$ext = array_merge($ext_misc,$ext_file); //allowed extensions
