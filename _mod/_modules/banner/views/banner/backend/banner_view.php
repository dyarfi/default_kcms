...
<form class="form_details" action="<?php echo url::site(ADMIN.$class_name.'/edit/'.$banner->id); ?>" method="get">
		<div class="form_wrapper">
			<div class="form_row">
				<label>Name</label>
				<div class="form_field"><?php echo HTML::chars($banner->name, TRUE); ?></div>
			</div>

			<div class="form_row">
				<label>Title</label>
				<div class="form_field"><?php echo HTML::chars($banner->subject, TRUE); ?></div>
			</div>
			
			<?php if (isset($show_description) && $show_description) : ?>
			<div class="form_row">
				<label>Description</label>
				<div class="form_field"><?php echo ($banner->description != '') ? $banner->description : '-'; ?></div>
			</div>
			<?php endif; ?>			
			...
			<div class="form_row">
				<label>Status</label>
				<div class="form_field"><?php echo ucfirst($banner->status); ?></div>
			</div>
			<div class="form_row">
				<label>Created</label>
				<div class="form_field"><?php echo ($banner->added != 0) ? date(Lib::config('site.date_format'), $banner->added) : '-'; ?></div>
			</div>
			<div class="form_row">
				<label>Last Modified</label>
				<div class="form_field"><?php echo ($banner->modified != 0) ? date(Lib::config('site.date_format'), $banner->modified) : '-'; ?></div>
			</div>
		</div>
		<div class="form_row">
