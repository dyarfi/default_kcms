...
<?php 
echo Form::open(URL::site(ADMIN.$class_name.'/edit/'.$client->id), array(
	...
	<div class="form_wrapper">	
        ...
        <div class="form_row">
            ...
            <select name="category_id" id="category_id" class="required">
                <option value="">&nbsp;</option>
                <option value="0" <?php echo ($fields['category_id'] == 0) ? 'selected="selected"' : ''; ?>>This <?php echo str_replace('_', ' ', $class_name); ?> is parent</option>
                <?php foreach ($categories as $row) : ?>
                <option value="<?php echo $row->id; ?>" class="division_<?php echo $row->id; ?>" <?php //echo ($row->id == $client->category_id) ? 'disabled="disabled"' : ''; ?> <?php echo ($fields['category_id'] == $row->id) ? 'selected="selected"' : ''; ?>><?php echo str_repeat('&nbsp;', 1 * 5).HTML::chars($row->subject, TRUE); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
			...
			<div class="form_row">
				...
				<select name="order" id="order">
					...
					<optgroup label="After ...">
						...
						<option value="<?php echo ($row->order + 1); ?>" <?php echo ($fields['order'] == ($row->order + 1)) ? 'selected="selected"' : ''; echo ($row->id == $client->id) ? ' disabled="disabled"' : ''; ?>><?php echo HTML::chars($row->title, TRUE); ?></option>
						<?php endforeach; ?>
					</optgroup>
					<?php endif; ?>
				</select>
		...
		<div class="form_row">
			<label>Created</label>
			<div class="form_field"><?php echo ($client->added != 0) ? date(Lib::config('site.date_format'), $client->added) : '-'; ?></div>
		</div>
		<div class="form_row">
			<label>Last Modified</label>
			<div class="form_field"><?php echo ($client->modified != 0) ? date(Lib::config('site.date_format'), $client->modified) : '-'; ?></div>
		</div>
	</div>	
    <div class="form_row">
