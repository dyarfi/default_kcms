...
<?php 
echo Form::open(URL::site(ADMIN.$class_name.'/edit/'.$category->id), array(
...
?>
	<div class="form_wrapper">
		...
		<?php echo sprintf($errors['subject'], 'Job Subject'); ?>
        <div class="form_row">
            <label>Subject</label>
        ...
        <div class="form_row">
            <label>Name</label>
            <input type="text" name="name" id="name" class="required" <?php echo $category->is_system ? 'readonly' : ''; ?> value="<?php echo $fields['name']; ?>" />
        </div>
            ...
            <fieldset style="clear:both;">
                ...
                <div class="form_row">
                    ...
                    <div class="form_fields">
                        <?php 
						//print_r(is_file(Lib::config($class_name.'.upload_path').$files[$row_name]->file_name));
						//print_r(Lib::config('career.upload_path')); exit();
						if (is_file(Lib::config($class_name.'.upload_path').$files[$row_name]->file_name) && in_array($files[$row_name]->file_type, $readable_mime)) : ?>
                        <div id="file_<?php echo $files[$row_name]->id; ?>">
                            ...
                            <?php
								...
								//print_r($files[$row_name]->file_type); exit();
                            ?>
                            <img src="<?php echo URL::base().Lib::config($class_name.'.upload_url').$file_data['filename'].$thumb_ext.'.'.$file_data['extension']; ?>" alt="<?php echo URL::base().Lib::config($class_name.'.upload_url').$files[$row_name]->file_name; ?>" />
                ...
                <div class="form_row">
                    ...
                    <div class="form_field"><a href="<?php echo URL::site(ADMIN.$class_name.'/download/'.$files[$row_name]->file_name); ?>"><img src="<?php echo URL::base(); ?>images/cms/icon/disk.png" alt="<?php echo $files[$row_name]->file_name; ?>" /></a></div>
                </div>
        ...
        <div class="form_row">
            <label>Created</label>
            <div class="form_field"><?php echo ($category->added != 0) ? date(Lib::config('admin.date_format'), $category->added) : '-'; ?></div>
        </div>
    
        <div class="form_row">
            <label>Last Modified</label>
            <div class="form_field"><?php echo ($category->modified != 0) ? date(Lib::config('admin.date_format'), $category->modified) : '-'; ?></div>
        </div>
	</div>
    <div class="form_row">
