...
<form class="form_details" action="<?php echo url::site(ADMIN.$class_name.'/edit/'.$category->id); ?>" method="get">
		<div class="form_wrapper">
			
			<div class="form_row">
				<label>Subject</label>
				<div class="form_field"><?php echo HTML::chars($category->subject, TRUE); ?></div>
			</div>
			
			<div class="form_row">
				<label>Name</label>
				<div class="form_field"><?php echo HTML::chars($category->name, TRUE); ?></div>
			</div>

			<?php if (isset($show_description) && $show_description) : ?>
			<div class="form_row">
				<label>Description</label>
				<div class="form_field"><?php echo ($category->description != '') ? $category->description : '-'; ?></div>
			</div>
			<?php endif; ?>			
			...
			<div class="form_row">
				<label>Status</label>
				<div class="form_field"><?php echo ucfirst($category->status); ?></div>
			</div>
			<div class="form_row">
				<label>Created</label>
				<div class="form_field"><?php echo ($category->added != 0) ? date(Lib::config('site.date_format'), $category->added) : '-'; ?></div>
			</div>
			<div class="form_row">
				<label>Last Modified</label>
				<div class="form_field"><?php echo ($category->modified != 0) ? date(Lib::config('site.date_format'), $category->modified) : '-'; ?></div>
			</div>
		</div>
		<div class="form_row">
