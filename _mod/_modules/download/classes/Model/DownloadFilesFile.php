...
class Model_DownloadFilesFile extends Model_Database {
	protected $table = 'download_file_files'; 
	protected $tbl_name;
	...
	public function install () {
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. '`download_id` INT(11) UNSIGNED NULL, '
	...
	public function find ($where_cond = '', $order_by = '', $limit = '', $offset = '') {
		...
		foreach ($rows as $row) {
			$object			= new Model_DownloadFilesFile;
