...
<form class="form_details" action="<?php echo url::site(ADMIN.$class_name.'/edit/'.$reseller->id); ?>" method="get">
		<div class="form_wrapper">
			<div class="form_row">
				<label>Name</label>
				<div class="form_field"><?php echo HTML::chars($reseller->name, TRUE); ?></div>
			</div>

			<div class="form_row">
				<label>Title</label>
				<div class="form_field"><?php echo HTML::chars($reseller->subject, TRUE); ?></div>
			</div>
			
			<?php if (isset($show_description) && $show_description) : ?>
			<div class="form_row">
				<label>Description</label>
				<div class="form_field"><?php echo ($reseller->description != '') ? $reseller->description : '-'; ?></div>
			</div>
			<?php endif; ?>			
			...
			<div class="form_row">
				<label>Status</label>
				<div class="form_field"><?php echo ucfirst($reseller->status); ?></div>
			</div>
			<div class="form_row">
				<label>Created</label>
