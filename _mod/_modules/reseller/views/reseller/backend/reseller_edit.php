...
echo Form::hidden('order', $reseller->order);
			...
			<div class="form_row">
				...
				<select name="order" id="order">
					...
					<optgroup label="After ...">
						...
						<option value="<?php echo ($row->order + 1); ?>" <?php echo ($fields['order'] == ($row->order + 1)) ? 'selected="selected"' : ''; echo ($row->id == $reseller->id) ? ' disabled="disabled"' : ''; ?>><?php echo HTML::chars($row->title, TRUE); ?></option>
						<?php endforeach; ?>
					</optgroup>
					<?php endif; ?>
				</select>
