...
class Model_PortfolioFilesFile extends Model_Database {
	protected $table = 'portfolio_file_files'; 
	protected $tbl_name;
	...
	public function install () {
		...
		$sql	= 'CREATE TABLE IF NOT EXISTS `'.$this->table.'` ('
				...
				. 'INDEX (`portfolio_id`, `name`, `allow_comment`, `status`) '
				. ') ENGINE=MYISAM';
	...
	public function load_by_filename ($file_name, $portfolio_id = '') {
		if ($portfolio_id != '') {
	...
	public function find ($where_cond = '', $order_by = '', $limit = '', $offset = '') {
		...
		foreach ($rows as $row) {
			$object			= new Model_PortfolioFilesFile;
